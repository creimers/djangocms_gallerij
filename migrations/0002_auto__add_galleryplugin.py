...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_gallerij_galleryplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djangocms_gallerij.Gallery'])),
        ))
        db.send_create_signal(u'djangocms_gallerij', ['GalleryPlugin'])


    def backwards(self, orm):
        # Deleting model 'GalleryPlugin'
        db.delete_table(u'djangocms_gallerij_galleryplugin')
    ...
    models = {
        ...
        u'djangocms_gallerij.galleryplugin': {
