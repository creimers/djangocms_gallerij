...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_gallerij_gallery', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'djangocms_gallerij', ['Gallery'])

        # Adding model 'Image'
        db.create_table(u'djangocms_gallerij_image', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True)),
            ('gallery', self.gf('adminsortable.fields.SortableForeignKey')(related_name='images', to=orm['djangocms_gallerij.Gallery'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'djangocms_gallerij_gallery')
