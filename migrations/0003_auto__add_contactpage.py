...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_gallerij_contactpage', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('background_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True)),
            ('text', self.gf('djangocms_text_ckeditor.fields.HTMLField')(blank=True)),
        ))
        db.send_create_signal(u'djangocms_gallerij', ['ContactPage'])


    def backwards(self, orm):
        # Deleting model 'ContactPage'
        db.delete_table(u'djangocms_gallerij_contactpage')
