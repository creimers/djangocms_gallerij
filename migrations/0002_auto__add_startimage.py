...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StartImage'
        db.create_table(u'djangocms_gallerij_startimage', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True)),
        ))
        db.send_create_signal(u'djangocms_gallerij', ['StartImage'])


    def backwards(self, orm):
        # Deleting model 'StartImage'
        db.delete_table(u'djangocms_gallerij_startimage')
